...
private:
    ...
    tinygl::Texture texture0{tinygl::Texture::Target::Target2D, "airplane.png", GL_RGB, GL_RGBA, true, 0};
    tinygl::Texture texture1{tinygl::Texture::Target::Target2D, "crate.jpg", GL_RGB, GL_RGB, true, 1};
...
void Window::init()
{
    ...
    program.addShaderFromSourceFile(tinygl::Shader::Type::Fragment, "06-02.frag");
    program.link();
...
void Window::draw()
{
    ...
    program.setUniformValue("texSampler1", 1);
    vao.bind();
